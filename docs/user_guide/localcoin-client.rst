...
*************************************
LocalCoin Client and Login Mode
*************************************
...
Light Client
----------------
Download client files and install LocalCoin Wallet to your computer.

**> Note: This download does not mean that you will have a Local wallet.**

- `Download the Official Light Client <http://localcoin.org/download/>`_
...
- **If you know you want to have a Local wallet, use an [advanced form] link on the Welcome to LocalCoin form and create a backup file. This is the only way to create a Local wallet.**
